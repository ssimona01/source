...
def model_fn(model_dir):
    ...
    with open(os.path.join(model_dir, 'basnet_bsi_epoch_9_train_0.012128_val_0.013882.pth'), 'rb') as f:
...
def input_fn(request_body, content_type='application/json'):
    ...
    if content_type == 'application/json':
        ...
        image_base64 = input_data['base64String']
        logger.info(f'Data: {image_base64}')
...
def predict_fn(input_data, model):
    ...
    with torch.no_grad():
        ...
        imo.save(buffered, format='JPEG')
        
        ps = base64.b64encode(buffered.getvalue())
